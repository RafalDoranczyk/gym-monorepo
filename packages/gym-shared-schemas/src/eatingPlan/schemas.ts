...
import { EATING_DAY_NAME_MAX_LENGTH, EATING_DAY_NAME_MIN_LENGTH } from './consts';
...
export type GetSingleEatingPlanPayload = Static<typeof GetSingleEatingPlanPayloadSchema>;
...
export type CreateEatingPlanPayload = Static<typeof CreateEatingPlanPayloadSchema>;

export const CreateEatingPlanResponseSchema = Type.Object({
  message: Type.String(),
  plan: EatingPlanSchema,
});
export type CreateEatingPlanResponse = Static<typeof CreateEatingPlanResponseSchema>;
...
export type UpdateEatingPlanPayload = Static<typeof UpdateEatingPlanPayloadSchema>;

export const UpdateEatingPlanResponseSchema = CreateEatingPlanResponseSchema;
export type UpdateEatingPlanResponse = Static<typeof UpdateEatingPlanResponseSchema>;

//REMOVE
export const RemoveEatingPlanPayloadSchema = Type.Object({
  id: EatingPlanSchema.properties.id,
});
export type RemoveEatingPlanPayload = Static<typeof RemoveEatingPlanPayloadSchema>;

export const RemoveEatingPlanResponseSchema = Type.Object({
  id: EatingPlanSchema.properties.id,
  message: Type.String(),
});
export type RemoveEatingPlanResponse = Static<typeof RemoveEatingPlanResponseSchema>;
